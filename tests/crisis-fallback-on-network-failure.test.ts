 ...
 * containing emergency numbers (1813, 112) instead of throwing a generic error.
 */
...
describe('crisis-fallback-on-network-failure', () => {
  ...
  it('returns static crisis-fallback with 1813 and 112 on network error (fetch throws)', async () => {
    ...
    expect(result.response).toContain('1813');
  ...
  it('returns static crisis-fallback with 1813 and 112 on HTTP error (500)', async () => {

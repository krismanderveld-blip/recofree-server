...
export const chatInputSchema = z.object({
  ...
  extractedEntities: z.object({
    persons: z.array(z.object({
      ...
      relationshipNL: z.string().optional().default(''),
      age: z.string().nullable().optional(),
      livingSituation: z.string().nullable().optional(),
      emotionalValence: z.string().optional().default('neutral'),
      context: z.string().optional().default(''),
      sourceSection: z.string().optional().default(''),
    }).passthrough()),
    events: z.array(z.object({
      ...
      emotionalImpact: z.string().optional().default(''),

...
const HERV_FR_MARKERS: MarkerDefinition[] = [
  ...
  { pattern: /\b(il|elle)\s+est\s+(ivre|bourr[eé]e?|sous\s+influence)\b/i, moduleCandidate: 'HERV-K01', markerType: 'active_use', markerId: 'fr_herv_est_ivre', confidence: 0.85 },
...
const NAHERV_FR_MARKERS: MarkerDefinition[] = [
  { pattern: /\b(il|elle)\s+a\s+rechut[eé]\b/i, moduleCandidate: 'NAHERV-K01', markerType: 'post_relapse', markerId: 'fr_naherv_rechute', confidence: 0.9 },
  ...
  { pattern: /\bje\s+suis\s+tellement\s+d[eé][cç]u[e]?\b/i, moduleCandidate: 'NAHERV-K01', markerType: 'post_relapse', markerId: 'fr_naherv_decu', confidence: 0.7 },
  { pattern: /\bje\s+suis\s+[eé]puis[eé][e]?\s+apr[eè]s\s+sa\s+rechute\b/i, moduleCandidate: 'NAHERV-K01', markerType: 'post_relapse', markerId: 'fr_naherv_epuise', confidence: 0.8 },
  ...
  { pattern: /\bj'ai\s+peur\s+d'esp[eé]rer\s+[aà]\s+nouveau\b/i, moduleCandidate: 'NAHERV-K01', markerType: 'post_relapse', markerId: 'fr_naherv_peur_esperer', confidence: 0.75 },
...
const CRISIS_FR_MARKERS: MarkerDefinition[] = [
  ...
  // Safety
  { pattern: /\bje\s+ne\s+suis\s+pas\s+en\s+s[eé]curit[eé]\b/i, moduleCandidate: 'CRISIS-K01', markerType: 'acute_danger', markerId: 'fr_crisis_pas_securite', confidence: 0.95 },
  { pattern: /\bles\s+enfants\s+ne\s+sont\s+pas\s+en\s+s[eé]curit[eé]\b/i, moduleCandidate: 'CRISIS-K01', markerType: 'acute_danger', markerId: 'fr_crisis_enfants', confidence: 0.95 },
  // Violence
  ...
  { pattern: /\b(il|elle)\s+m'a\s+frapp[eé]\b/i, moduleCandidate: 'CRISIS-K01', markerType: 'violence', markerId: 'fr_crisis_frappe', confidence: 0.95 },
  // Disappearance
  ...
  { pattern: /\b(il|elle)\s+ne\s+r[eé]pond\s+pas\b/i, moduleCandidate: 'CRISIS-K01', markerType: 'disappearance', markerId: 'fr_crisis_repond_pas', confidence: 0.7 },
  // Suicide / self-harm
  ...
  // Medical emergency
  { pattern: /\b(il|elle)\s+a\s+pris\s+des\s+m[eé]dicaments\b/i, moduleCandidate: 'CRISIS-K01', markerType: 'medical_emergency', markerId: 'fr_crisis_medicaments', confidence: 0.95 },

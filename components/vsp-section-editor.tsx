                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
                    {hasFilled && (
                      <View style={{ backgroundColor: zone.color + '20', borderRadius: 8, paddingHorizontal: 6, paddingVertical: 2 }}>
                        <Text style={{ fontSize: 10, color: zone.color, fontWeight: '500' }}>{'\u2713'}</Text>
                      </View>
                    )}
                    <Text style={{ color: colors.muted, fontSize: 12 }}>{isExpanded ? '\u25B2' : '\u25BC'}</Text>
                  </View>
                </View>
              </View>
            </Pressable>
          ...
          <View style={{
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
                ...
                <Text style={{ color: colors.muted, fontSize: 12 }}>{expandedZone === 'triggers' ? '\u25B2' : '\u25BC'}</Text>
              </View>
            </View>
          </View>
        </Pressable>
          ...
          <View style={{
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
                ...
                <Text style={{ color: colors.muted, fontSize: 12 }}>{expandedZone === 'rules' ? '\u25B2' : '\u25BC'}</Text>
              </View>
            </View>
          </View>
        </Pressable>

...
OUTPUT JSON SCHEMA:
{
  ...
  "schemas": [{ "schema": "abandonment"|"mistrust_abuse"|"emotional_deprivation"|"defectiveness_shame"|"dependence_incompetence"|"vulnerability"|"enmeshment"|"subjugation"|"self_sacrifice"|"unrelenting_standards"|"entitlement"|"insufficient_self_control"|"approval_seeking"|"negativity_pessimism"|"emotional_inhibition"|"punitiveness", "evidenceType": "explicit"|"inferred", "confidence": 0-1 }],
  "modes": [{ "mode": "vulnerable_child"|"angry_child"|"impulsive_child"|"compliant_surrender"|"detached_protector"|"overcontroller"|"punitive_parent"|"demanding_parent"|"healthy_adult", "evidenceType": "explicit"|"inferred", "confidence": 0-1 }],

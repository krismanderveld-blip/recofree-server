...
const MEDICAL_CLINICAL_PATTERNS = /\b(adhd|medicatie|detox|ontwenning|cold turkey|afkicken|herstel|therapie|behandeling|psychiater|psycholoog|huisarts|red bull|cafeïne|suiker|slaappillen|antidepressiva|zenuwstelsel|dopamine|serotonine|verslaving.*hersen|brain|withdrawal)\b/i;
